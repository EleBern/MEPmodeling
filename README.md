This branch is used to add a white Gaussian noise to the MUAP, to the synthetically generated DI-waves and to the MEPs to test how it affects the performance of the model.
